...
class CommunityInvolvement extends AppModel {
    public $useTable = 'community_involvement';
...
public function processUpload($check=array()) {
    ...
    if (!empty($check['filename']['tmp_name'])) {
        ...
        $filePath = WWW_ROOT . $this->uploadDir . DS . "community" . DS . "involvement" ;
      ...
      //inserting the path to the image from WWW_ROOT
        ...
        $this->data['CommunityInvolvement']['main_image_path'] = $this->uploadDir . DS . "community" . DS . "involvement" . DS . $fileName ;
