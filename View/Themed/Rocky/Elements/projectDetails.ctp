    ...
    $categories = array_keys($projectsByCategory);
     ...
     ?>
              <div id="" class="jumbotron">
               <div class="container">
                   <p id='<?php echo $this->Link->removeNonAlphaNumerics($category) ?>'>Project Details (<?php echo $category ?>)<p/>
   ...
   <!--     /*
         ...
         */
   -->
<h4 id="<?php echo $this->Link->getLocationByCategoryHrefLink($projectDetail,$category ); ?>"><?php  echo $projectDetail['title'] ?></h4>
