...
# Database: rockycoast
# Generation Time: 2014-04-19 14:27:28 +0000
# ************************************************************
...
VALUES
	...
	(196,1,NULL,NULL,'Pages',390,403),
	(197,196,NULL,NULL,'display',391,392),
	(198,1,NULL,NULL,'Projects',404,407),
	(199,198,NULL,NULL,'index',405,406),
	(201,1,NULL,NULL,'Rocky',408,411),
	(202,201,NULL,NULL,'index',409,410),
	(206,1,NULL,NULL,'DebugKit',412,419),
	(207,206,NULL,NULL,'ToolbarAccess',413,418),
	(208,207,NULL,NULL,'history_state',414,415),
	(209,207,NULL,NULL,'sql_explain',416,417),
	(210,58,NULL,NULL,'admin_moveup',124,125),
	(211,58,NULL,NULL,'admin_movedown',126,127),
	(212,1,NULL,NULL,'Wysiwyg',420,421),
	(217,1,NULL,NULL,'ContactPage',422,427),
	(218,217,NULL,NULL,'index',423,424),
	(219,217,NULL,NULL,'save',425,426),
	(220,1,NULL,NULL,'ProjectAdmin',428,441),
	(221,220,NULL,NULL,'index',429,430),
	(222,220,NULL,NULL,'listProjects',431,432),
	(223,220,NULL,NULL,'viewProject',433,434),
	(224,220,NULL,NULL,'add',435,436),
	(225,220,NULL,NULL,'editProject',437,438),
	(226,220,NULL,NULL,'deleteProject',439,440),
	(233,196,NULL,NULL,'aboutus',393,394),
	(234,196,NULL,NULL,'safety',395,396),
	(235,196,NULL,NULL,'awards',397,398),
	(236,1,NULL,NULL,'CommunityLogos',442,453),
	(237,236,NULL,NULL,'index',443,444),
	(238,236,NULL,NULL,'listLogos',445,446),
	(239,236,NULL,NULL,'add',447,448),
	(242,236,NULL,NULL,'edit',449,450),
	(243,236,NULL,NULL,'delete',451,452),
	(250,1,NULL,NULL,'CommunityAdmin',454,465),
	(251,250,NULL,NULL,'index',455,456),
	(252,250,NULL,NULL,'listInvolvements',457,458),
	(253,250,NULL,NULL,'add',459,460),
	(254,250,NULL,NULL,'edit',461,462),
	(255,250,NULL,NULL,'delete',463,464),
	(256,1,NULL,NULL,'Community',466,471),
	(257,256,NULL,NULL,'index',467,468),
	(258,256,NULL,NULL,'listInvolvements',469,470),
	(259,196,NULL,NULL,'community',399,400),
	(260,196,NULL,NULL,'login',401,402);
...
VALUES
	...
	(3,NULL,'Role',3,'Role-public',1,12),
	(4,1,'User',1,'rockyadmin',4,5),
	(5,3,'User',2,'rockypublicuser',10,11),
	(6,2,'User',3,'rockyregistered',7,8);
...
# Dump of table community_involvement
# ------------------------------------------------------------
...
INSERT INTO `community_involvement` (`id`, `description`, `main_image_path`)
VALUES
	(1,'afjdkl fdkls; afjkdl s;afjkdl ;safjkldsa','uploads/community/involvement/capoeira.jpg');

/*!40000 ALTER TABLE `community_involvement` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table community_logos
# ------------------------------------------------------------

DROP TABLE IF EXISTS `community_logos`;

CREATE TABLE `community_logos` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `community_logos` WRITE;
/*!40000 ALTER TABLE `community_logos` DISABLE KEYS */;

INSERT INTO `community_logos` (`id`, `image_path`, `description`)
VALUES
	(6,'uploads/community/logos/capoeira.jpg','capoeira'),
	(7,'uploads/community/logos/download.jpeg','bbbbb'),
	(8,'uploads/community/logos/DD800E07_A45E_49EE_B74D_5535866D969E.jpg','mmmmmm'),
	(9,'uploads/community/logos/iBStriped_386x386.jpg','nnnnnn'),
	(10,'uploads/community/logos/2Willow.jpg','njbjklbj');

/*!40000 ALTER TABLE `community_logos` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(32,'Hook.bootstraps','Settings,Comments,Contacts,Nodes,Meta,Menus,Users,Blocks,Taxonomy,FileManager,Ckeditor,DebugKit','','','',0,23,''),
...
VALUES
	...
	(3,2,'rockyregistered','','Rocky Registered','rockyregistereduser@gmail.com','www.gatech.edu','6ee93893676818ea6916bdbc2206ca2c',NULL,NULL,'0',1,'2014-04-19 04:53:30','2014-04-19 04:53:21');
